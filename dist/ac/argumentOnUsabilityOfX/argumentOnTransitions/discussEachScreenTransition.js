...
export const argument = new Argument(new Inference("Discuss each screen transition", [
    new SupportedClaim(new Claim(`Transition from page A to page B takes less than ${params["TRANSITION_TIME_MS_FROM_A_TO_B"]} milliseconds.`), UndevelopedArgument, [])
], [
