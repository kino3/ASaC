...
export const argument = new Argument(new Inference("Argument over each page", [
    ...
    new SupportedClaim(new Claim(`Page B screen display finishes within ${params["RESPONSE_TIME_MS_B"]} milliseconds.`), new UndevelopedArgument(), []),
    new SupportedClaim(new Claim(`Page C screen display finishes within ${params["RESPONSE_TIME_MS_C"]} milliseconds.`), new UndevelopedArgument(), [])
], []), []);
